...
| (_) || '  \()| ' \))| | | _ \| |/ _` |/ _| | / /  
 \___/ |_|_|_| |_||_| |_| |___/|_|\__,_|\__| |_\_\  v2.0
    """ + Style.RESET_ALL)
...
└────────────────────────────────────┘
    ...
    def ip_lookup(self, ip):
        ...
        print(Fore.CYAN + f"\n{'='*60}")
        print(f"ИТОГО: {len(results)} источников API + 6 ссылок")
        print(f"{'='*60}" + Style.RESET_ALL)
        return results
